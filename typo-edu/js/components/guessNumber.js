...
const bx = BX.components.GuessNumber.bx(scheme);
bx.appendTo(topBox);`,
    lessonBook: '',
    appCode : `
...
function clickNumberButton(e) {
    ...
    appTitle: '숫자 맞추기',
    bgCode : `title('Guess Number');`
};

BX.regist('GuessNumber', compData);
let title, appendNumberButton, getResult, getRandomNumber; //실습에 사용할 함수들.
